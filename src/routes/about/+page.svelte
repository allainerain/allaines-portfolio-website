...
{#if ready}
    <section class="grid gap-12 items-center justify-center max-w-[1300px] w-[90%]">
        ...
        <section class="grid grid-cols-1 lg:grid-cols-2 gap-16 md:mt-40 mt-10">
            <div transition:fly={{y: 300, duration: 800}} class="relative overflow-hidden max-h-[600px] rounded-[20px] lg:order-last">
            ...
            <div transition:fly={{y: 300, duration: 800}} class="flex flex-col gap-8 lg:order-first">
                <div in:blur={{amount: 100, duration: 800}} class="flex flex-col gap-2 text-light-accent masked-text">
        ...
        <section class="grid grid-cols-1 lg:grid-cols-2 w-full gap-16 lg:max-h-[700px] ">
            ...
            {#key hobbySrc}
                <div in:fade class="relative overflow-hidden max-h-[600px] rounded-[20px] lg:order-last">
                    <img class="object-cover w-full transition-opacity duration-500 ease-in-out" alt="Me" src={hobbySrc}/>
                    <div class="absolute top-0 left-0 w-full h-full fade-corner"></div>
                </div>
            {/key}
        </section>
...
<style>
    ...
    .masked-text::before {
        ...
        width: 100%;
        height: 100%;
        background: radial-gradient(circle at center, rgba(255, 255, 255, 0) 50%, rgba(255, 255, 255, 0.7) 80%);
        pointer-events: none;
    } 
</style>